                ...
                <div class="card-body">
                    <form action="/action_page.php">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="nama" class="form-control" id="nama" placeholder="Input Nama Lengkap"
                                name="nama">
                        </div>
                        <div class="mb-3 mt-3">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="username" class="form-control" id="username" placeholder="Input NPM"
                                name="username">
                        </div>
                        <div class="mb-3">
                        ...
                        <a class="btn btn-primary" href="/loginMahasiswa" role="button">Daftar</a>
